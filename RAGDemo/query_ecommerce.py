...
def main():
    ...
    parser = argparse.ArgumentParser(description="Query the E-commerce RAG pipeline.")
    ...
    if not os.path.exists(CHROMA_DB_DIR):
        print(f"Error: Chroma database directory '{CHROMA_DB_DIR}' not found. Please run ingest_ecommerce.py first.")
        sys.exit(1)
    ...
    if google_api_key:
        ...
        system_prompt = (
            "You are an assistant for question-answering tasks for an e-commerce dataset. "
